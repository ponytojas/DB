...
select discos.titulo_disco from discos inner join canciones  on canciones.codigo_disco_cancion = discos.codigo_disco group by discos.titulo_disco  having count(*) > 4 
