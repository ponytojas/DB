...
truncate table compra_entrada cascade;
truncate table usuario_compra cascade;
...
VALUES ('42765363Z', cast(2 as integer), 5);
INSERT INTO USUARIO_COMPRA(DNI_USUARIO_COMPRA, CODIGO_COMPRA, OPINION)
VALUES ('73737078K', cast(2 as integer), 8);
INSERT INTO USUARIO_COMPRA(DNI_USUARIO_COMPRA, CODIGO_COMPRA, OPINION)
VALUES ('73737078K', cast(3 as integer), 5);
