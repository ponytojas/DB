...
CREATE TABLE ENTRADAS (
	...
	CONSTRAINT FK_CODIGO_CONCIERTO_ENTRADA FOREIGN KEY (CODIGO_CONCIERTO) REFERENCES CONCIERTOS (CODIGO_CONCIERTO),
...
CREATE TABLE DISCOS(
	...
	CONSTRAINT FK_CODIGO_GRUPO_DISCO FOREIGN KEY (CODIGO_GRUPO) REFERENCES GRUPOS (CODIGO_GRUPO)
...
CONSTRAINT FK_CODIGO_DISCO_CANCION FOREIGN KEY (CODIGO_DISCO) REFERENCES DISCOS (CODIGO_DISCO)
);
...
CREATE TABLE OPINIONES (
	...
	CONSTRAINT FK_DNI_USUARIO_OPINION FOREIGN KEY (DNI_USUARIO) REFERENCES USUARIOS (DNI_USUARIO)
);
