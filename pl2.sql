...
CREATE TABLE CONCIERTO(
	...
	CONSTRAINT FK_CODIGO_GRUPO_CONCIERTO FOREIGN KEY (CODIGO_GRUPO_CONCIERTO) REFERENCES GRUPO (CODIGO_GRUPO)
);
...
CREATE TABLE MUSICO(
	...
	CONSTRAINT FK_GRUPO_MUSICO FOREIGN KEY (CODIGO_GRUPO_MUSICO) REFERENCES GRUPO(CODIGO_GRUPO)
);
...
CREATE TABLE DISCO(
	...
	CONSTRAINT FK_CODIGO_GRUPO_DISCO FOREIGN KEY (CODIGO_GRUPO_DISCO) REFERENCES GRUPO (CODIGO_GRUPO),
...
CREATE TABLE CANCION(
	...
	CONSTRAINT FK_ID_COMPOSITOR FOREIGN KEY (ID_COMPOSITOR_CANCION) REFERENCES COMPOSITOR (CODIGO_COMPOSITOR),
	CONSTRAINT FK_CODIGO_DISCO_CANCION FOREIGN KEY (CODIGO_DISCO_CANCION) REFERENCES DISCO (CODIGO_DISCO)
);
...
CREATE TABLE COMPRA(
	...
	CONSTRAINT FK_CODIGO_DISCO_COMPRA FOREIGN KEY (CODIGO_DISCO_COMPRA) REFERENCES DISCO (CODIGO_DISCO),
...
/*Usuario*/
INSERT INTO USUARIOS VALUES ('64510552Z', 'jose.lopez@jmail.com', 'Jose', 'Lopez');
INSERT INTO USUARIOS VALUES ('15625422G', 'paloma.guerrero@witty.com', 'Paloma', 'Guerra');
INSERT INTO USUARIOS VALUES ('89237576Z', 'saul.ballesteros@lycos.com', 'Saul', 'Ballesteros');
INSERT INTO USUARIOS VALUES ('23213623E', 'milagros.gordillo@jmail.com', 'Milagros', 'Gordillo');
INSERT INTO USUARIOS VALUES ('57417089G', 'jeromio.abad@jmail.com', 'Jerónimo', 'Abad');
INSERT INTO USUARIOS VALUES ('01225251H', 'alba.galvez@jmail.com', 'Alba', 'Galvez');
INSERT INTO USUARIOS VALUES ('31060609Y', 'estela.palomo@witty.com', 'Estela', 'Palomo');
INSERT INTO USUARIOS VALUES ('26443180B', 'omar.herrera@witty.com', 'Omar', 'Herrera');
INSERT INTO USUARIOS VALUES ('77560483K', 'carmen.ros@jmail.com', 'Carmen', 'Ros');
INSERT INTO USUARIOS VALUES ('26538645A', 'aurelia.arce@lycos.com', 'Aurelia', 'Arce');
INSERT INTO USUARIOS VALUES ('92566518M', 'eneko.asensio@witty.com', 'Eneko', 'Asensio');
INSERT INTO USUARIOS VALUES ('42765363Z', 'ramon.gutierrez@jmail.com', 'Ramón', 'Gutierrez');
INSERT INTO USUARIOS VALUES ('33668608N', 'gloria.amador@witty.com', 'Gloria', 'Amador');
INSERT INTO USUARIOS VALUES ('73737078K', 'salvador.marquez@jmail.com', 'Salvador', 'Marquez');
INSERT INTO USUARIOS VALUES ('59146333Q', 'begona.falcon@jmail.com', 'Begoña', 'Falcón');
INSERT INTO USUARIOS VALUES ('64242692N', 'arias.mendez@lycos.com', 'Arias', 'Mendez');
INSERT INTO USUARIOS VALUES ('92644697F', 'ana.tirados@lycos.com', 'Ana', 'Tirados');
INSERT INTO USUARIOS VALUES ('59547081N', 'amelia.losada@witty.com', 'Amelia', 'Losada');
INSERT INTO USUARIOS VALUES ('86842356Z', 'joana.toro@lycos.com', 'Joana', 'Toro');
...
INSERT INTO COMPRAS(ES_COMPRA_DISCO, CODIGO_DISCO_COMPRA) 
